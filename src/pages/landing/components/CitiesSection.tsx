                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 text-white md:p-6">
                  ...
                  {!city.active && (
                    <button
                      ...
                      className="relative z-10 mt-4 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-xs font-semibold text-orange-600 shadow-sm transition-all hover:bg-orange-50 hover:shadow-md"
                    >
