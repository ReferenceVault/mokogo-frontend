            ...
            <div className="mb-8 sm:mb-12 relative overflow-hidden rounded-xl md:rounded-[2rem] border border-orange-200 bg-gradient-to-br from-orange-50 via-white to-orange-50/50 p-5 sm:p-8 md:p-10 shadow-xl shadow-orange-100/40">
              ...
              <div className="relative">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
                  ...
                  <h2 className="text-xl sm:text-2xl font-semibold text-gray-900">Understanding Cookies</h2>
                </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2 mb-8 sm:mb-12">
              ...
              <div className="relative overflow-hidden rounded-xl md:rounded-[2rem] border border-orange-200 bg-gradient-to-br from-orange-50 via-white to-orange-50/50 p-5 sm:p-8 md:p-10 shadow-xl shadow-orange-100/40">
                ...
                <div className="relative">
                  ...
                  <h3 className="mt-4 text-xl sm:text-2xl font-semibold text-gray-900">Mokogo uses cookies to:</h3>
              ...
              <div className="relative overflow-hidden rounded-xl md:rounded-[2rem] border border-orange-200 bg-gradient-to-br from-[#fff4f1] via-white to-[#fffafa] p-5 sm:p-8 md:p-10 shadow-xl shadow-[#f8d8cf]/45">
                ...
                <div className="relative">
                  ...
                  <h3 className="mt-4 text-xl sm:text-2xl font-semibold text-[#0f172a]">Cookies we do not use</h3>
            ...
            <div className="mb-8 sm:mb-12">
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6 sm:mb-8">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900">Types of cookies we use</h2>
                </div>
              </div>
                    ...
                    >
                      ...
                      <div className="relative">
                        <button
                          ...
                          className="w-full flex items-start gap-3 sm:gap-4 p-4 sm:p-6 hover:bg-orange-50/50 transition-colors text-left"
                        >
                          <div className="flex-shrink-0">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-orange-400/10 flex items-center justify-center">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-2 mb-1 sm:mb-2">
                              <div className="flex items-center gap-2 min-w-0">
                                <span className="text-sm font-semibold text-orange-500 flex-shrink-0">{cookieType.number}.</span>
                                <h3 className="text-base sm:text-lg font-semibold text-gray-900 truncate">{cookieType.title}</h3>
                              </div>
                              {isExpanded ? (
                        ...
                        {isExpanded && (
                          <div className="px-4 sm:px-6 pb-4 sm:pb-6 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                            {cookieType.helps && (
                              <>
              ...
              <div className="relative">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4 sm:mb-6">
                  ...
                  <div>
                    ...
                    <h2 className="mt-2 text-xl sm:text-2xl font-semibold text-gray-900">Your choices and controls</h2>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-xl md:rounded-[2rem] border border-orange-200 bg-gradient-to-br from-orange-50 via-white to-orange-50/50 p-5 sm:p-8 md:p-10 shadow-xl shadow-orange-100/40">
                ...
                <div className="relative">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Updates to this Cookie Policy</h3>
                  </div>
