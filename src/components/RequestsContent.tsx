...
const RequestsContent = ({ onViewListing }: RequestsContentProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50/30 via-white to-orange-50/20">
      ...
      {/* Action Bar - Outside Contact Requests Section */}
      <section className="px-8 py-4 bg-white border-b border-orange-200/50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button 
              className={`px-4 py-2 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 ${
                selectedRequests.length > 0
                  ? 'bg-gradient-to-r from-green-400 to-green-500 text-white hover:shadow-lg hover:shadow-green-500/30 hover:scale-105'
            ...
            <button 
              className={`px-4 py-2 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 ${
                selectedRequests.length > 0
                  ? 'bg-gradient-to-r from-red-400 to-red-500 text-white hover:shadow-lg hover:shadow-red-500/30 hover:scale-105'
                  : 'bg-gray-200 text-gray-400 cursor-not-allowed'
              }`}
              disabled={selectedRequests.length === 0}
            >
            ...
            <div className="ml-auto flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <select 
                  ...
                  className="px-4 py-2 border border-orange-200 rounded-lg text-sm font-medium bg-white focus:outline-none focus:ring-2 focus:ring-orange-400 min-w-[160px]"
                >
      ...
      <section className="px-8 py-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Your Active Listings</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            {[
              { title: 'Spacious Room in Baner', status: 'Active', rent: '₹12,000/month', details: '1 Bed • Female Preferred', requests: '8 new requests', color: 'green', id: 'listing-1766972864442' },
              { title: 'Modern Room in Hinjawadi', status: 'Active', rent: '₹15,000/month', details: '1 Bed • Any Gender', requests: '3 new requests', color: 'green', id: 'listing-1766972864442' },
              { title: 'Cozy Room in Wakad', status: 'Paused', rent: '₹9,500/month', details: 'Shared Bath • Male Preferred', requests: '1 pending request', color: 'yellow', id: 'listing-1766972864442' }
            ].map((listing, index) => (
              <div
                key={index}
                className="relative bg-white/80 backdrop-blur-sm rounded-lg border border-orange-200/50 p-4 shadow-md hover:shadow-lg hover:scale-[1.01] transition-all duration-300 group"
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="text-base font-semibold text-gray-900 group-hover:text-orange-600 transition-colors flex-1 pr-2">{listing.title}</h3>
                  ...
                  <p className="text-xs text-gray-600 mb-1.5">{listing.rent} • {listing.details}</p>
                  ...
                  {listing.status === 'Paused' ? (
                    <button className="text-xs font-semibold text-orange-600 hover:text-orange-700 flex items-center gap-1 group-hover:gap-1.5 transition-all">
                      Reactivate <Play className="w-3.5 h-3.5" />
                    </button>
                  ) : (
                  <button 
                    onClick={() => {
                    ...
                    className="text-xs font-semibold text-orange-600 hover:text-orange-700 flex items-center gap-1 group-hover:gap-1.5 transition-all"
                  >
      ...
      <section className="px-8 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900">Priority Requests</h2>
            <p className="text-xs text-gray-600">Verified users and high-match profiles</p>
          </div>
                  ...
                  <div className="flex items-start gap-3 mb-3">
                    <div className="relative flex-shrink-0">
                      <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-orange-200">
                        ...
                        <div className="absolute top-0 right-0 w-4 h-4 bg-yellow-400 rounded-full flex items-center justify-center">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <div className="flex items-center gap-2 mb-1.5">
                            <h4 className="text-base font-bold text-gray-900">{request.name}</h4>
                          </div>
                          <div className="flex flex-wrap items-center gap-1.5 mb-1.5">
                            {request.verified && (
                              <span className="px-1.5 py-0.5 bg-green-100 text-green-700 rounded-full text-xs font-semibold flex items-center gap-1">
                                <CheckCircle className="w-2.5 h-2.5" />
                                Verified
                              </span>
                            )}
                            {request.badges.map((badge, i) => (
                              <span key={i} className={`px-1.5 py-0.5 rounded-full text-xs font-semibold ${
                          ...
                          <div className="flex flex-wrap items-center gap-3 text-xs text-gray-600 mb-1.5">
                      ...
                      <p className="text-xs text-gray-700 leading-relaxed mb-3 italic">"{request.message}"</p>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-3">
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-gray-600">Interested in:</span>
                          <span className="inline-block px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-semibold">
                            {request.interestedIn}
                          </span>
                        </div>
                        <div className="flex flex-wrap gap-3 ml-auto">
                          <button className="px-3 py-1.5 bg-red-50 text-red-600 rounded-lg text-xs font-semibold hover:bg-red-100 transition-all duration-300 flex items-center gap-1.5">
                            <XCircle className="w-3.5 h-3.5" />
                            Reject
                          </button>
                          <button className="px-3 py-1.5 bg-yellow-50 text-yellow-700 rounded-lg text-xs font-semibold hover:bg-yellow-100 transition-all duration-300 flex items-center gap-1.5">
                            <MessageSquare className="w-3.5 h-3.5" />
                            Message First
                          </button>
                          <button className="px-3 py-1.5 bg-gradient-to-r from-green-400 to-green-500 text-white rounded-lg text-xs font-semibold hover:shadow-lg hover:shadow-green-500/30 hover:scale-105 transition-all duration-300 flex items-center gap-1.5">
      ...
      <section className="px-8 py-4 bg-white/50">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900">Recent Requests</h2>
            <p className="text-xs text-gray-600">10 new requests in the last 24 hours</p>
          </div>
      ...
      <section className="px-8 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl md:text-2xl font-bold text-gray-900">Previously Responded</h2>
            <Link to="#" className="text-xs font-semibold text-orange-600 hover:text-orange-700 flex items-center gap-1">
      ...
      <section className="px-8 py-4 bg-gradient-to-br from-orange-50/50 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Smart Matching Insights</h2>
          <p className="text-sm text-gray-600 mb-4">AI-powered recommendations to help you make better decisions</p>
      ...
      <section className="px-8 py-4 bg-gradient-to-br from-orange-50/50 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Safety Guidelines for Listers</h2>
          <p className="text-sm text-gray-600 mb-4">Best practices to ensure secure interactions with potential roommates</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            {safetyGuidelines.map((guideline, index) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-orange-50/30 via-transparent to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="relative">
                  <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-orange-400 to-orange-500 flex items-center justify-center mb-2 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <guideline.icon className="w-4 h-4 text-white" />
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-1.5 text-xs">{guideline.title}</h3>
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-lg border border-orange-200/50 p-4 shadow-md">
            <div className="absolute inset-0 bg-gradient-to-br from-orange-50/30 via-transparent to-transparent rounded-lg" />
            <div className="relative flex items-start gap-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-orange-400 to-orange-500 flex items-center justify-center flex-shrink-0 shadow-lg">
                <Shield className="w-4 h-4 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-1.5 text-xs">Pro Tip</h3>
      ...
      <section className="px-8 py-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Your Listing Performance</h2>
          <p className="text-sm text-gray-600 mb-4">Track how your listings are performing and optimize for better results</p>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    const getColorClass = (rate: number) => {
                      ...
                      if (rate >= 60) return 'bg-gradient-to-r from-orange-400 to-orange-500'
                    ...
                    return (
                      <div key={index}>
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-xs font-medium text-gray-700">{item.listing}</span>
                          <span className={`text-xs font-semibold ${getTextColor(item.rate)}`}>{item.rate}%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                          <div 
                            className={`${getColorClass(item.rate)} h-1.5 rounded-full transition-all duration-500`}
                  ...
                  <div className="pt-3 border-t border-orange-200">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-semibold text-gray-900">Average Response Rate</span>
                      <span className="text-base font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">81.3%</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    const getColorClass = (requests: number) => {
                      if (requests >= 5) return 'bg-gradient-to-r from-blue-500 to-blue-600'
                      if (requests >= 4) return 'bg-gradient-to-r from-indigo-400 to-indigo-500'
                      if (requests >= 3) return 'bg-gradient-to-r from-purple-400 to-purple-500'
                      if (requests >= 2) return 'bg-gradient-to-r from-pink-400 to-pink-500'
                      return 'bg-gradient-to-r from-orange-400 to-orange-500'
                    }
                    const getTextColor = (requests: number) => {
                      if (requests >= 5) return 'text-blue-600'
                      if (requests >= 4) return 'text-indigo-600'
                      if (requests >= 3) return 'text-purple-600'
                      if (requests >= 2) return 'text-pink-600'
                      return 'text-orange-600'
                    }
                    return (
                      <div key={index}>
                        <div className="flex items-center justify-between mb-1">
                          <span className="text-xs text-gray-700">{item.day}</span>
                          <span className={`text-xs font-semibold ${getTextColor(item.requests)}`}>{item.requests} requests</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                          <div 
                            className={`${getColorClass(item.requests)} h-1.5 rounded-full transition-all duration-500`}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div 
                key={index}
                className="relative bg-white/80 backdrop-blur-sm rounded-lg border border-orange-200/50 p-3 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 group text-center"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-orange-50/30 via-transparent to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="relative">
                  <h3 className="text-lg font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent mb-1 flex items-center justify-center gap-1">
                    {stat.isRating ? (
                      <>
