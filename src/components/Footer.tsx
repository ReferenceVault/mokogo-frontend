      ...
      <div className="max-w-7xl mx-auto px-16 py-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              <a 
                href="#" 
                className="text-gray-600 hover:text-mokogo-primary transition-colors"
                aria-label="Facebook"
              >
          ...
          {/* Column 2: Vacant placeholder */}
          <div>
            {/* Empty placeholder column */}
          </div>
          
          {/* Column 3: For Seekers */}
          <div>
        ...
        <div className="border-t border-mokogo-gray mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
            ...
            <p>© 2025 MOKOGO. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
